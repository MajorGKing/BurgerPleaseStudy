...
public class Restaurant : MonoBehaviour
{
	...
	{
		Managers.Event.AddEvent(Define.EEventType.HireWorker, OnHireWorker);
		StartCoroutine(CoDistributeWorkerAI());
	}

    private void OnDisable()
    {
        Managers.Event.RemoveEvent(Define.EEventType.HireWorker, OnHireWorker);
    }
    ...
    void OnHireWorker()
    {
        GameObject go = Managers.Resource.Instantiate(Define.WORKER);
